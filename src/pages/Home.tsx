          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[320px]">
            {projects.map((project, i) => (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-3xl bg-white flex flex-col justify-end p-6 border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all ${project.colSpan === 2 ? 'md:col-span-2 lg:col-span-2' : 'col-span-1'
                  }`}
              >
                {project.imageUrl && (
